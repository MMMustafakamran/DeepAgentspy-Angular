 ...
 *
 * Used by the scripted takes (actions/take.ts) for notes that must be legible
 * on a 1080p capture and sit clear of the evidence: unlike
 * core/overlays/notepad.ts, this window takes a position and a font size.
 *
 * This is framework-agnostic and **belongs in `core/`** --
 * it knows nothing about Angular, Deep Agents or CopilotKit, and every repo using this
